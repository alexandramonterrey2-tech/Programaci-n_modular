...
Funcion peso <- pedirPeso(numPersona)
    ...
    Escribir "Ingrese el peso de la persona ", numeroPersona, " (kg): "
    Leer peso
FinFuncion
Funcion altura <- pedirAltura(numPersona)
    Definir altura Como Real
    Escribir "Ingrese la altura de la persona ", numeroPersona, " (m): "
    Leer altura
FinFuncion
...
SubProceso mostrarIMC(numPersona, imc)
    Escribir "El IMC de la persona ", numeroPersona, " es: ", imc
FinSubProceso
