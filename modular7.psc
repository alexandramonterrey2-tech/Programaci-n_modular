Algoritmo modular7
    Definir prom_m1, prom_n2, prom_n3, prom_general Como Real	
    prom_m1 <- promedioMateria(1)
    prom_m2 <- promedioMateria(2)
    prom_m3 <- promedioMateria(3)
	
    prom_general <- promedioGeneral(prom_n1, prom_n2, prom_n3)
    imprimirPromedio("Materia 1", prom_n1)
    imprimirPromedio("Materia 2", prom_n2)
    imprimirPromedio("Materia 3", prom_n3)
    imprimirPromedio("General", prom_general)
FinAlgoritmo
Funcion promedio <- promedioMateria(numMateria)
    Definir n1, n2, n3, promedio Como Real
    Escribir "Materia ", numeroMateria, ":"
